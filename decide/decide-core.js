...
const CARD = {
  ...
  sample: {
    topic: '例：年会費11,000円のゴールドカードに切り替える？',
    verdict: '判定：GO（条件つき）',
    rows: [
      { l: '決め手', v: '年200万円をこのカードに集約するなら、還元＋ラウンジ＋付帯保険で年会費を回収できる。あなたの利用額なら回収ラインを超える。' },
      { l: '「無料カード継続」を捨てる理由', v: '無料カードは還元0.5%止まり。集約額が大きいほど、取り逃す還元が年会費を上回る。' },
      { l: 'あなたが見落としがちな点', v: '継続ボーナスの条件・家族カードの扱い・切替時の締め日ズレによる一時的な二重支払い。' },
      { l: '今日やる一手', v: '直近12ヶ月の総利用額を出す → 回収ラインを1分で計算 → 超えていれば今月の締め日前に申込。' },
    ],
  },
  choiceA: '申し込む',
  choiceB: '見送る',
...
const SIM = {
  ...
  subtitle: 'スマホの通信費',
  sample: {
    topic: '例：大手キャリア(月8,000円・20GB)から格安SIMに乗り換える？',
    verdict: '判定：GO（乗り換え推奨）',
    rows: [
      { l: '決め手', v: '月20GB以下＆家族割に縛られていないなら、格安SIMで月5,000円前後・年6万円の削減が見込める。' },
      { l: '「大手継続」を捨てる理由', v: '使っていないかけ放題・店舗サポートに年6万円は割高。乗り換えは基本1回で済む。' },
      { l: 'あなたが見落としがちな点', v: '家族割・自宅ネットのセット割で失う額、キャリアメール、乗り換え月の日割り・事務手数料。' },
      { l: '今日やる一手', v: '直近3ヶ月の平均データ量と通話時間を出す → 対応する格安SIMを1つ選ぶ → MNPワンストップで乗り換え。' },
    ],
  },
  choiceA: '乗り換える',
  choiceB: '今のまま',
...
const SUB = {
  ...
  subtitle: '月額サービスの見直し',
  sample: {
    topic: '例：月1,480円の動画サブスク、解約する？',
    verdict: '判定：解約（今は見送り）',
    rows: [
      { l: '決め手', v: '直近1ヶ月ほぼ未使用＆同じ内容が既契約や無料で代替できるなら、月1,480円・年17,760円はムダ。' },
      { l: '「継続」を捨てる理由', v: '“いつか見るかも”のための年17,760円は割高。見たい時にすぐ入り直せるなら継続の必要はない。' },
      { l: 'あなたが見落としがちな点', v: '年払い済みの残期間、同一アカウントの家族利用、解約で失う視聴履歴・ダウンロード。' },
      { l: '今日やる一手', v: '直近30日の利用回数を確認 → 代替(既契約/無料)を1つ挙げる → 無ければ解約し、次の請求日をメモ。' },
    ],
  },
  choiceA: '解約する',
  choiceB: '続ける',
...
const HIKARI = {
  ...
  sample: {
    topic: '例：月5,700円の光回線、他社へ乗り換える？',
    verdict: '判定：GO（条件つき）',
    rows: [
      { l: '決め手', v: 'スマホと同系列のセット割が効く回線に乗り換えれば、月1,000〜1,100円×回線数の割引で、工事費を含めても1年前後で回収できる。' },
      { l: '「現状維持」を捨てる理由', v: '今の回線にセット割が無いなら、毎月の割引を取り逃し続ける。乗り換えは基本1回で済む。' },
      { l: 'あなたが見落としがちな点', v: '契約期間の縛り・解約金、キャッシュバックの受取条件と期限、工事日までの空白、マンションの対応回線。' },
      { l: '今日やる一手', v: '今の月額と契約更新月を確認 → スマホと同系列のセット割対象回線を1つ選ぶ → キャッシュバック条件を読んで申込。' },
    ],
  },
  choiceA: '乗り換える',
  choiceB: '今のまま',
